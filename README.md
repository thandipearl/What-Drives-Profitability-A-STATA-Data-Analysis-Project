...
Using STATA, I analyzed firm-level financial and operational data to uncover the key drivers behind profit margins. This project walks through the full data analysis process — from cleaning the data to running advanced econometric models.
